    ...
    namespace EcoChallengerTest.Utils
    {
        public static class GenericFunctions {
            ...
            public static async Task SeedTestUsers()
            {
                ...
                // Navigate to the user object and get the ID
                ...
                {
                    new  { UserId = userId, TagName = testTags[1].Name, SelectedTag = true} ,
                    new  { UserId = userId, TagName = testTags[2].Name, SelectedTag = false },
                };
                ...
                {
                    new ProfileFriendModel { Id = userId, FriendUsername = "testuser"},
                    new ProfileFriendModel { Id = userId, FriendUsername = "Tester3"}
                };
                ...
                {
                    new ChallengeModel { Title = "testChallenge1", Description = "descricao1", Points = 20, Type = "Daily", UserId = userId},
                    new ChallengeModel { Title = "testChallenge2", Description = "descricao2", Points = 20, Type = "Daily", UserId = userId},
                    new ChallengeModel { Title = "testChallenge3", Description = "descricao3", Points = 20, Type = "Daily", UserId = userId},
                    new ChallengeModel { Title = "testChallenge4", Description = "descricao4", Points = 50, Type = "Weekly", MaxProgress = 3, UserId = userId},
                    new ChallengeModel { Title = "testChallenge5", Description = "descricao5", Points = 50, Type = "Weekly", MaxProgress = 4, UserId = userId},
                };
